...
{
    /// <summary>
    ///     Register an instance of an ESME (Extended Short Message Entity) with the SMSC (Short Message Service Centre)
    ...
    public class BindSm : Header, IPacket, IPduDetails
    {
        ...
        private BindSm(DataCodings defaultEncoding) : base(defaultEncoding,
            CommandSet.BindTransceiver,
        ...
        public List<PduPropertyDetail> Details()
        {
            ...
            try
            {
                ...
                details.Add(PduData.ExtractCString("SystemId",
                    ref offset));
                details.Add(PduData.ExtractCString("Password",
                    ref offset));
                details.Add(PduData.ExtractCString("SystemType",
                    ref offset));
                details.Add(PduData.ExtractByte("InterfaceVersion",
                    ref offset));
                details.Add(PduData.ExtractByte("AddrTon",
                    ref offset));
                details.Add(PduData.ExtractByte("AddrNpi",
                    ref offset));
                details.Add(PduData.ExtractCString("AddressRange",
                    ref offset));
            }
        ...
        /// <summary>
        ///     Identifies a set of SME addresses. Regular Expression notation should be used to
