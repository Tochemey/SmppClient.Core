    ...
    public class QuerySmResp : Header, IPacket, IPduDetails
    {
        ...
        public List<PduPropertyDetail> Details()
        {
            ...
            try
            {
                ...
                details.Add(PduData.ExtractCString("MessageId",
                    ref offset));
                details.Add(PduData.ExtractCString("FinalDateString",
                    ref offset));
                details.Add(PduData.ExtractByte("MessageState",
                    ref offset));
                details.Add(PduData.ExtractByte("ErrorCode",
                    ref offset));
            }
        ...
        public DateTime FinalDate
        {
            get
            {
                ...
                if (FinalDateString != null && FinalDateString.Length > 0)
                    try
                    {
                        date = DateTime.ParseExact(FinalDateString,
                            "yyMMddHHmmss",
                    ...
                    catch
                    {
                        ...
                        date = DateTime.ParseExact(FinalDateString.Substring(0,
                                12),
                            "yyMMddHHmmss",
                            CultureInfo.InvariantCulture,
                            DateTimeStyles.AllowWhiteSpaces);
            ...
            set => FinalDateString = value.ToString("yyMMddHHmmss",
                CultureInfo.InvariantCulture);
        }
        ...
        private QuerySmResp(DataCodings defaultEncoding) : base(defaultEncoding,
            CommandSet.QuerySmResp)
        { }
        ...
        private QuerySmResp(DataCodings defaultEncoding,
        ...
        public static QuerySmResp Create(DataCodings defaultEncoding,
            CommandStatus status)
        {
            return new QuerySmResp(defaultEncoding,
                status,
                0);
        }
        ...
        public static QuerySmResp Create(DataCodings defaultEncoding,
            ...
            ref int offset)
        {
            var querySmResp = new QuerySmResp(defaultEncoding);

            try
            {
                buf.ExtractHeader(querySmResp,
                    ref offset);
