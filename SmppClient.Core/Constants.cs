...
namespace SmppClient.Core
{
    ...
    /// <summary>
    ///     ESME (Extended Short Message Entity) may bind to the SMSC (Short Message Service Centre) as either a
    ///     Transmitter (called ESME Transmitter), a Receiver (called ESME Receiver) or a Transceiver (called ESME Transceiver)
    /// </summary>
    ...
    public enum OptionalTags : ushort
    {
        ...
        /// <summary>
        ///     The sar_msg_ref_num parameter is used to indicate the reference number for a particular concatenated short
        ///     message
        /// </summary>
        SarMsgRefNum = 0x020C,
        ...
        /// <summary>
        ///     The sar_total_segments parameter is used to indicate the total number of short messages within the
        ///     concatenated short message
        /// </summary>
        SarTotalSegments = 0x020E,

        /// <summary>
        ///     The sar_segment_seqnum parameter is used to indicate the sequence number of a particular short message within
        ...
        /// <summary>
        ///     The more_messages_to_send parameter is used by the ESME in the submit_sm and data_sm operations to indicate
        ///     to the SMSC that there are further messages for the same destination SME. The SMSC may use this setting for network
