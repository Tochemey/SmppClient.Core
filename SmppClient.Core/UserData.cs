...
namespace SmppClient.Core
{
    ...
    public class UserData
    {
        ...
        {
            foreach (var userDataHeader in userData.Headers) Headers.Add(userDataHeader);
        ...
        public byte[] ShortMessage
        {
            ...
            set => _ShortMessage = new List<byte>(value);
        }
        ...
        /// <returns> UserData</returns>
        public static UserData Create(SmppBuffer buf,
            bool udhi)
        {
            return buf.ExtractUserData(udhi,
                0);
        }
