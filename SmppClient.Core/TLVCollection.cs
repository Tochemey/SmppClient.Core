...
namespace SmppClient.Core
{
    ...
    public class TLVCollection : List<TLV>
    {
        ...
        {
            get { return this.FirstOrDefault(k => k.Tag == tag); }
        }
        ...
        {
            var tmpBuff = new SmppBuffer(DataCodings.Default);
            tmpBuff.AddShort(val);

            Add(TLV.Create(OptionalTags.SarMsgRefNum,
                Convert.ToUInt16(tmpBuff.Length),
                tmpBuff.Buffer));
        }
        ...
        public void AddSARSequenceNumber(byte val)
        {
            ...
            Add(TLV.Create(OptionalTags.SarSegmentSeqnum,
                Convert.ToUInt16(tmpBuff.Length),
                tmpBuff.Buffer));
        }
        ...
        public void AddSARTotalSegments(byte val)
        {
            ...
            Add(TLV.Create(OptionalTags.SarTotalSegments,
                Convert.ToUInt16(tmpBuff.Length),
                tmpBuff.Buffer));
        }
        ...
        public void AddMoreMessagesToSend(bool val)
        {
            ...
            Add(TLV.Create(OptionalTags.MoreMessagesToSend,
                Convert.ToUInt16(tmpBuff.Length),
                tmpBuff.Buffer));
        }
        ...
        public void AddMessagePayload(byte[] data)
        {
            ...
            Add(TLV.Create(OptionalTags.MessagePayload,
                Convert.ToUInt16(tmpBuff.Length),
                tmpBuff.Buffer));
        }
