...
namespace SmppClient.Core
{
    ...
    public class UserDataHeader
    {
        ...
        /// <summary> Identifies Information Element in the User Data Header </summary>
        public InformationElementIdentifiers IEI
        {
            get => _IEI;
            set
            {
        ...
        public byte[] Data
        {
            ...
            {
                _Data = value;
                Length = Convert.ToByte(_Data.Length);
            }
        }
        ...
        private UserDataHeader(byte iei,
            byte len,
            byte[] data)
        {
            IEI_Id = iei;
            ...
            var obj = Enum.Parse(typeof(InformationElementIdentifiers),
                IEI_Id.ToString());
            if (obj != null) _IEI = (InformationElementIdentifiers) obj;
            else _IEI = InformationElementIdentifiers.Unknown;
        }
        ...
        /// <param name="len"></param>
        /// <param name="data"></param>
        private UserDataHeader(InformationElementIdentifiers iei,
            byte len,
            byte[] data)
        {
        ...
        /// <param name="data"></param>
        /// <returns> UserDataHeader </returns>
        internal static UserDataHeader Create(byte iei,
            byte len,
            byte[] data)
        {
            return new UserDataHeader(iei,
                len,
                data);
        }
        ...
        /// <param name="data"></param>
        /// <returns> UserDataHeader </returns>
        internal static UserDataHeader Create(InformationElementIdentifiers iei,
            byte len,
            byte[] data)
        {
            return new UserDataHeader(iei,
