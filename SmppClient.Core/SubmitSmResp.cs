...
namespace SmppClient.Core
{
    ...
    public class SubmitSmResp : Header, IPacket, IPduDetails
    {
        ...
        public static SubmitSmResp Create(DataCodings defaultEncoding,
            ...
            string messageId)
        {
            if (submitSm.DestAddr == string.Empty || submitSm.DestAddr == null) commandStatus = CommandStatus.ESME_RINVDSTADR;
            ...
            ref int offset)
        {
            ...
            try
            {
                ...
                if (submitSmResp.Length > HEADER_LENGTH)
                {
                    ...
                    while (offset - start_offset < submitSmResp.Length) submitSmResp.Optional.Add(buf.ExtractTLV(ref offset));
                }
            }
