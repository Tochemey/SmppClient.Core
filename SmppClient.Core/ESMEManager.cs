...
namespace SmppClient.Core
{
    ...
    public class EsmeManager : IDisposable
    {
        ...
        private readonly List<EsmeConnection> Receivers = new List<EsmeConnection>();

        /// <summary> A dictionary of transmitter connections </summary>
        private readonly Dictionary<int, EsmeConnection> Transmitters = new Dictionary<int, EsmeConnection>();
        ...
        public EsmeManager(string logKey,
            string shortLongCode,
        ...
        protected void Dispose(bool disposing)
        {
            ...
            if (!Disposed)
            {
                ...
                try
                {
                    ...
                    foreach (var smppConnection in Receivers) smppConnection.Dispose();
                }

                catch (Exception exception)
                {
                    WriteLog(LogEventNotificationTypes.Email,
                        "ESMEManager : Dispose : ERROR : {0}",
                        exception.ToString());
                }
                ...
                try
                {
                    ...
                    foreach (var smppConnection in Transmitters.Values) smppConnection.Dispose();
                }
        ...
        /// <param name="connectionEventType"></param>
        /// <param name="message"></param>
        public void ConnectionEventConnectionHandler(string logKey,
            ConnectionEventTypes connectionEventType,
            string message)
        {
        ...
        /// <param name="dataCoding"></param>
        /// <param name="message"></param>
        public void ReceivedMessageConnectionHandler(string logKey,
            string serviceType,
            Ton sourceTon,
            Npi sourceNpi,
            string shortLongCode,
        ...
        /// <param name="logKey"></param>
        /// <param name="sequence"></param>
        public void ReceivedGenericNackConnectionHandler(string logKey,
            int sequence)
        {
        ...
        /// <param name="sequence"></param>
        /// <param name="messageId"></param>
        public void SubmitMessageConnectionHandler(string logKey,
            int sequence,
            string messageId)
        {
        ...
        /// <param name="messageState"></param>
        /// <param name="errorCode"></param>
        public void QueryMessageConnectionHandler(string logKey,
            int sequence,
            string messageId,
            DateTime finalDate,
            int messageState,
        ...
        /// <param name="message"></param>
        /// <param name="logKey"></param>
        public void LogEventConnectionHandler(LogEventNotificationTypes logEventNotificationType,
            string logKey,
            string shortLongCode,
            string message)
        {
        ...
        /// <param name="details"></param>
        /// <returns> External Id </returns>
        private Guid? PduDetailsConnectionHandler(string logKey,
            PduDirectionTypes pduDirectionType,
            Header pdu,
            List<PduPropertyDetail> details)
        {
        ...
        private void AddTransceiverConnection(int connectionId,
            string host,
            int port,
            string userName,
            string password,
        ...
        /// <param name="logKey"></param>
        /// <param name="defaultEncoding"></param>
        private void AddReceiverConnection(int connectionId,
            string host,
            int port,
            string userName,
            string password,
        ...
        private EsmeConnection NextTransmitterConnection()
        {
            ...
            for (var connection = 0; connection < totalConnections; ++connection)
                lock (Transmitters)
                {
                    ...
                    if (++NextTransmitter > Transmitters.Count()) NextTransmitter = 1;

                    if (smppConnection.Status == ConnectionStatus.Bound) break;
            ...
            out List<SubmitSmResp> submitSmRespList)
        {
            ...
            try
            {
                ...
                // Send the message
                retVal = smppConnection.SendMessageLarge(phoneNumber,
                    serviceType,
                    sourceTon,
                    sourceNpi,
                    submitDataCoding,
