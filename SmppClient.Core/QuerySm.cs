...
namespace SmppClient.Core
{
    ...
    public class QuerySm : Header, IPacket, IPduDetails
    {
        ...
        private QuerySm(DataCodings defaultEncoding) : base(defaultEncoding,
            CommandSet.QuerySm,
        ...
        private QuerySm(DataCodings defaultEncoding,
            string messageId,
            byte sourceTon,
            byte sourceNpi,
            string sourceAddr) : base(defaultEncoding,
            CommandSet.QuerySm,
            SequenceGenerator.Counter)
        {
            MessageId = messageId;
        ...
        public static QuerySm Create(DataCodings defaultEncoding,
            ...
            string sourceAddr)
        {
            return new QuerySm(defaultEncoding,
                messageId,
                sourceTon,
                sourceNpi,
                sourceAddr);
