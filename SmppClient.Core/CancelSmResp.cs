...
namespace SmppClient.Core
{
    ...
    public class CancelSmResp : Header, IPacket, IPduDetails
    {
        ...
        private CancelSmResp(DataCodings defaultEncoding) : base(defaultEncoding,
        ...
        internal static CancelSmResp Create(DataCodings defaultEncoding,
            ...
            ref int offset)
        {
            var cancelSmResp = new CancelSmResp(defaultEncoding);

            try
            {
                buf.ExtractHeader(cancelSmResp,
                    ref offset);
            }

            catch { cancelSmResp = null; }
